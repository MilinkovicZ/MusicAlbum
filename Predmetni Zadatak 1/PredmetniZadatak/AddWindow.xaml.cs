    ...
    public partial class AddWindow : Window
    {
        ...
        private void btnDodaj1_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (validate())
            {
                ...
                FileStream fs;
                string path = @"C:\Users\zdrav\Desktop\HCI Projekat\RTBFiles\" + tbPesma.Text + ".rtf";
        ...
        private bool validate()
        {
            ...
            {
                isValid = false;
                labelSlikaGreska.Content = "Ubaciti sliku!";
            }
            else
            {
